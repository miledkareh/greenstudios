...
$sql = "SELECT id, title, start, end, color,player1,player2,player3,player4,member1,member2,member3,member4,invitation1,invitation2,invitation3,invitation4,(select Name from players where serial=events.player1) as player1name,(select Name from players where serial=events.player2) as player2name,(select Name from players where serial=events.player3) as player3name,(select Name from players where serial=events.player4) as player4name,resource,turn FROM events where deleted='0000-00-00'";
