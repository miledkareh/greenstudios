        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Predefined Text</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php }  ?>
	...
	<label>Description</label><textarea class="form-control" type="text"   name="description"  id="description" style="width:100%;" required rows="5"></textarea>
        </div>
