                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['ccce']!=1){ echo('disabled'); }?>>Add</button>
...
<?php }  ?>
	...
	<label>Cost</label>
<input class="form-control" type="number"   name="cost"  id="cost" style="width:100%;" required>
