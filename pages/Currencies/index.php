                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['curce']!=1){ echo('disabled'); }?>>Add Currency</button>
...
<?php }  ?>
	...
	<label>Symbol</label><input class="form-control" type="text"   name="symbol"  id="symbol" style="width:100%;" required>
        </div>
