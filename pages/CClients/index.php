        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Clients Colors</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['ccce']!=1){ echo('disabled'); }?>>Add Color</button>
...
<?php }  ?>
	...
	<label>Specialty</label><input class="form-control" type="text"   name="specialty"  id="specialty" style="width:100%;" required>
	<label>Color</label>
...
<script src="../../js/cclients.js"></script>
</body>
