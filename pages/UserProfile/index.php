                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['upce']!=1){ echo('disabled'); }?> >Add User Profile</button>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>Description</th>
										  <?php if($_SESSION['upce']==1){?>      <th>Privilege</th> <?php }?>
										  <?php if($_SESSION['upce']==1){?>      <th>Edit</th> <?php }?>
									   <?php if($_SESSION['upcd']==1){?>      <th>Delete</th> <?php }?>
                                    </tr>
                                </thead>
                                <tbody>
								<?php
...
while($x = mysqli_fetch_array($results)){?>
                                    <tr class="odd gradeX">
                                        ...
                                        <?php if($_SESSION['upce']==1){?>   <td> <a href="./privilege.php?x=<?php echo($x["Serial"]);?>" > Privilege </a></td><?php }  ?>
										 
                                   <?php if($_SESSION['upce']==1){?>
<td class="center">
<a  id="Edit_<?php echo($x["Serial"]);?>"  data-toggle="modal" data-target="#myModal" ><p class="fa fa-edit"></p> Edit</a>
</td>
<?php }  ?>
<?php if($_SESSION['upcd']==1){?>
      ...
      <div class="modal-content"  width="100px">
        ...
        <div class="modal-body" align="center">
			<label>Description</label><input class="form-control" type="text"   name="description"  id="description" style="width:100%;" required>
				...
				<option value="1"> All</option><option value="2"> Country</option><option value="3"> Project</option>
				</select>
				<br>
				<div width="100%">
				<div  id="Div1" >
				<select class="form-control" id="datafilter" name= "datafilter" style="width: 100%; " size="15" multiple="multiple"></select> 
				</div>
				<div  id="Div2"  >
					<?php	$query = "Select * From offers";
$results = mysqli_query($dbhandle,$query)  or die(mysqli_error());
?>
				<select class="form-control" id="datafilterr" name= "datafilterr" style="width: 100%; " size="15" multiple="multiple">
				<?php
mysqli_data_seek($results, 0);
 ...
 <?php 
				 ...
				 <div class="checkbox">
        <label>
        <input type="checkbox" id="hide" value="hide">Hide Prices & Correspondance
        </label>
        </div>
