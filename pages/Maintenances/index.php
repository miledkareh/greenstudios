...
<td><?php echo($x["RGAREA"]);?></td>
 ...
 <td><a href="./attachments1.php?x=<?php echo($x["Serial"]);?>&y=<?php echo($x["projectname"]);?>" ><?php echo($x["cntatt"]);?></a></td>
...
<label style="cursor:pointer">Company <input type="radio" name="contactstatus" value="Company"/> </label>
<label style="cursor:pointer">Contact <input type="radio" name="contactstatus" value="Contact"/></label>
<label style="cursor:pointer">Other <input type="radio" name="contactstatus" value="Other"/></label>
