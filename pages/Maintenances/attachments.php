        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Visits - Attachments</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$query = "Select * From maintenanceattachement where maintenancedetailid=".$_GET['x']." and isnew=0 and approved=1 order by dat desc";
...
while($x = mysqli_fetch_array($results)){?>
                                    ...
                                    <tr class="odd gradeX" data-toggle="tooltip" data-placement="top" >                                   	
                                        	 ...
                                        	 <td><a href="../../att/visits/<?php echo($x["status"]."/".$x["maintenancedetailid"]."/".str_replace("#","%23",$x["description"]));?>" target="_blank"><?php echo($x["description"]);?></td>
...
<td class="center"><a href="#" id="del_<?php echo($x["Serial"]);?>"   <?php if($_SESSION['mcd']!=1){ echo('disabled'); }?> ><p class="fa fa-trash-o"></p> Delete</a></td>
<?php }  ?>
                                    </tr>
									<?php 
}?>
...
<script src="../../js/vattachments.js"></script>
</body>
