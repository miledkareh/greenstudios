...
(select GWAREA from offers where serial in (select offerid from maintenances where serial in (select maintenanceid from maintenancedetails where serial=checkin.visit))) as GWAREA,
(select RGAREA from offers where serial in (select offerid from maintenances where serial in (select maintenanceid from maintenancedetails where serial=checkin.visit))) as RGAREA,
...
if($x['GWAREA']!=0)$area=$x['GWAREA'];
if($x['RGAREA']!=0)$area=$x['RGAREA'];



} ;
?> <h2 class="page-header">  Project Expenses -<?php echo $proj."-".$area." m<sup>2</sup>"; ?> 
...
include('../configdb.php');
    $query=  "Select *,
    (select description from servicescost where serial=visitcost.serviceid)as description,
    (select dat from checkin where visit=visitcost.visitid ) as dat,
    SUM(cost) as SUMCOST   
    from visitcost where visitid='".$_GET['x']."'
     group by(visitid)";
...
(select description from servicescost where serial=visitcost.serviceid)as description,
(select dat from checkin where visit=visitcost.visitid ) as dat,
(select GWAREA  from offers    where serial=visitcost.projectid  )as GWAREA ,
(select RGAREA  from offers    where serial=visitcost.projectid)as RGAREA ,
SUM(cost) as SUMCOST  
 from visitcost where visitid='".$_GET['x']."'
 group by(visitid)";
...
while($x = mysqli_fetch_array($results)){?>
                                    ...
                                    <tr class="odd gradeX" >              
                                        ...
                                        else{echo round($x['SUMCOST']/$x['RGAREA'],2);}?></td>
...
(select description from servicescost where serial=visitcost.serviceid)as description,
(select dat from checkin where visit=visitcost.visitid ) as dat,
(select employees from maintenancedetails where serial=visitcost.visitid)as employees,
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 
 from visitcost where visitid='".$_GET['x']."' and serviceid=2";
...
(select description from servicescost where serial=visitcost.serviceid)as description,
(select dat from checkin where visit=visitcost.visitid ) as dat,
 (select nbplants from readingm where maintenancedetail_id=visitcost.visitid) as PLANTS ,
(select employees from maintenancedetails where serial=visitcost.visitid)as employees,
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 
 from visitcost where visitid='".$_GET['x']."' and (serviceid=3  or serviceid=4) limit 1";
...
(select description from servicescost where serial=visitcost.serviceid)as description,
(select dat from checkin where visit=visitcost.visitid ) as dat,
(select galonsnb from readingm where maintenancedetail_id=visitcost.visitid) as GALONS ,
 (select nbplants from readingm where maintenancedetail_id=visitcost.visitid) as PLANTS ,
(select employees from maintenancedetails where serial=visitcost.visitid)as employees,
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 
 from visitcost where visitid='".$_GET['x']."' and (serviceid=6  or serviceid=7) limit 1";
...
(select description from servicescost where serial=visitcost.serviceid)as description,
(select dat from checkin where visit=visitcost.visitid ) as dat,
 (select trade from pesticide where maintenancedetail_id=visitcost.visitid) as PEST ,
(select galonsnb from readingm where maintenancedetail_id=visitcost.visitid) as GALONS ,
 (select nbplants from readingm where maintenancedetail_id=visitcost.visitid) as PLANTS ,
(select employees from maintenancedetails where serial=visitcost.visitid)as employees,
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 
 from visitcost where visitid='".$_GET['x']."' and serviceid=5";
...
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 ...
 from visitcost where visitid='".$_GET['x']."' and serviceid=1";
...
(select TIMEDIFF(checkoutdate, checkindate) from checkin where visit=visitcost.visitid) as time
 ...
 from visitcost where visitid='".$_GET['x']."' and serviceid=8";
