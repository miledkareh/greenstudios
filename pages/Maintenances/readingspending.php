        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"><?php echo $_GET['y'];?> -  Pending Readings <?php  
...
if($x['GWINT']==1 && $x['GWEXT']==1) echo "Indoor/Outdoor"; else if($x['GWINT']==1) echo "Indoor"; else if($x['GWEXT']==1) echo "Outdoor"; echo "- GW AREA ".$x['GWAREA'];
?>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
...
$query = "select *,(select SUM(watercons) from irrigationflow where irrigationflow.dat=AA.dat) as TOT from irrigationflow as AA where maintenanceid=".$_GET['x']."    order by dat desc";
...
<td class="center"><a href="#" id="dell_<?php echo($x["serial"]);?>"    ><p class="fa fa-trash-o"></p> Delete</a></td>
             ...
             <div style="float: right;padding-right: 25px;padding-bottom: 25px"><input class="btn btn-outline btn-primary"  type="button" name="approved" id="approved" value="approved"></div>
                  ...
                  <div class="row">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1" style="font-size: 85%;">
								...
								<?php
include('../configdb.php');
$query = "select * from irrigationtime where maintenancedetail_id=".$_GET['x']."  and accepted=0 order by dat desc";
                  ...
                  <div class="row">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example3" style="font-size: 85%;">
								...
								<?php
include('../configdb.php');
$query = "select * from readingm where maintenancedetail_id=".$_GET['x']."  and accepted=0 order by dat desc";
                  ...
                  <div class="row">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example4" style="font-size: 85%;">
								...
								<?php
include('../configdb.php');
$query = "select * from pesticide where maintenancedetail_id=".$_GET['x']." and accepted=0 order by dat desc";
   ...
   <div class="modal fade" id="myModal1" role="dialog" width="100px">
    <div class="modal-dialog" width="100px">
      ...
      <div class="modal-content"  width="100px">
		...
		End Time<input class="form-control" type="time"   name="endtime"  id="endtime" step="1" style="width:100%;" required>
        </div>
        <div class="modal-footer" >
  ...
  <div class="modal fade" id="myModal4" role="dialog" width="100px">
    <div class="modal-dialog" width="100px">
      ...
      <div class="modal-content"  width="100px">
		...
		Trade Name<select class="form-control"     name="trade"  id="trade" style="width:100%;" required>
...
<script src="../../js/readingspending.js"></script>
</body>
