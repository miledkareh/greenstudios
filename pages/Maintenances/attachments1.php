        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"><?php echo $_GET['y'];?> - Attachments</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$query = "Select * From maintenanceattachement where maintenanceid=".$_GET['x']." and approved=1 and  isnew=0";
if($_SESSION['Hide']==1)
$query.=" and status='wip' ";
$query.=" order by dat desc";
...
while($x = mysqli_fetch_array($results)){?>
                                    ...
                                    <tr class="odd gradeX" data-toggle="tooltip" data-placement="top" >                                   	
                                        	 ...
                                        	 <td><a href="../../att/<?php echo($x["status"]."/".$x["description"]);?>" target="_blank"><?php echo($x["description"]);?></td>
...
<script src="../../js/mattachments.js"></script>
</body>
