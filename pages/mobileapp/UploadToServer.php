...
$VISIT=$_GET['visitid'];
       if (!file_exists('../../att/visits/wip/'.$VISIT)) {
    mkdir('../../att/visits/wip/'.$VISIT, 0777, true);
 }
...
$ext = end((explode(".", $name)));
    $file_path = "../../att/visits/".$VISIT."/";
        $file_path2 = "../../att/visits/wip/".$VISIT."/";

        $file_path = $file_path . $name;
          $file_path2 = $file_path2 . $name;
...
copy($file_path,$file_path2);
             ...
             // move_uploaded_file($tmp_name, $file_path2);
              if($ext=="txt"){
