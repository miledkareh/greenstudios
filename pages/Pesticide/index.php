        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Pesticides  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['pestce']!=1){ echo('disabled'); }?>>Add Pesticide</button>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>Trade</th>
                                         <?php if($_SESSION['pestce']==1){?>      <th>Edit</th> <?php }?>
									   <?php if($_SESSION['pestcd']==1){?>      <th>Delete</th> <?php }?>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php }  ?>
	...
	<label>Trade</label><input class="form-control" type="text"    id="pesticide" style="width:100%;" required>
...
<script src="../../js/allpesticide.js"></script>
<script>
