                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['irce']!=1){ echo('disabled'); }?>>Add Area</button>
...
$query = "Select * From offers where Serial=".$_GET['x'];
$results = mysqli_query($dbhandle,$query)  or die(mysqli_error());
while($z = mysqli_fetch_array($results)){?>
                                       <?php if($z['GW']==1) {?>
                                       <th>GW INDOOR</th>
                                       <?php }else if($z['RG']==1) {?>
                                       <th>RG INDOOR</th>
...
$query = "Select * From invoicearea where invoice=".$_GET['y'];
...
<?php }  ?>
	...
	<label>Total</label>
<input class="form-control" type="number"   name="total"  id="total" style="width:100%;" required>
        </div>
        <div class="modal-footer" >
		
        	<label id ="lblalert" style="visibility: hidden; color: red;">Description and Total must be Filled !</label>
		<table align="center"  >
