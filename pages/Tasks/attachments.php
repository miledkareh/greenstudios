        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Task - Attachments</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['tce']!=1){ echo('disabled'); }?> >Add Attachment</button>
...
$query = "Select * From taskattachments where save=1 and taskid=".$_GET['x'];

$results = mysqli_query($dbhandle,$query)  or die(mysqli_error());
while($x = mysqli_fetch_array($results)){?>

                                    <tr class="odd gradeX">                                   	
                                        <td><a href="../../att/Tasks/<?php echo(str_replace("#","%23",$x["description"]));?>" target="_blank"><?php echo($x["description"]);?></td>
...
<td class="center"><a href="" id="del_<?php echo($x["serial"]);?>"   <?php if($_SESSION['tcd']!=1){ echo('disabled'); }?> ><p class="fa fa-trash-o"></p> Delete</a></td>
<?php }  ?>
                                    </tr>
									<?php 
}?>
    ...
    <div class="col-lg-12 nopadding" align="center">
        ...
        <input type="submit" id="add1" class="btn btn-outline btn-primary" value="Save" >
		</td>
		<td width="10">
		</td>
		<td>
...
<script src="../../js/taskattachments.js"></script>
</body>
