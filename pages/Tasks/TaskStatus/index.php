    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Roof 11</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="right">
							   ...
							   <button type="button" id="Add" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModal" <?php if($_SESSION['tasce']!=1){ echo('disabled'); }?>>Add Status</button>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" data-page-length='50' id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>Description</th>
                                         <?php if($_SESSION['tasce']==1){?>      <th>Edit</th> <?php }?>
									   <?php if($_SESSION['tascd']==1){?>      <th>Delete</th> <?php }?>
                                    </tr>
                                </thead>
                                <tbody>
...
while($x = mysqli_fetch_array($results)){?>
                                    ...
                                    <tr class="odd gradeX" style="background-color:<?php echo($x["color"]);?>;">                                   	
                                       ...
                                       <?php if($_SESSION['tasce']==1){?>
<td class="center">
<a  id="Edit_<?php echo($x["serial"]);?>"  data-toggle="modal" data-target="#myModal" ><p class="fa fa-edit"></p> Edit</a>
</td>
<?php }  ?>
<?php if($_SESSION['tascd']==1){?>
<td class="center"><a href="" id="del_<?php echo($x["serial"]);?>"   <?php if($_SESSION['tascd']!=1){ echo('disabled'); }?> ><p class="fa fa-trash-o"></p> Delete</a></td>
<?php }  ?>
                                    </tr>
									<?php 
}?>
	...
	<label>Status</label><input class="form-control" type="text"   name="status"  id="status" style="width:100%;" required>
	<label>Color</label>
	...
	<table>
		<tr>
			<td>
						 <div class="checkbox">
        <label>
        <input type="checkbox" id="default" value="nocolor">Default
        </label>
        </div>
			</td>
			<td>&nbsp;&nbsp;</td>
			<td>
				<div class="checkbox">
        <label>
        <input type="checkbox" id="nocolor" value="nocolor">No Color
        </label>
        </div>
			</td>
		</tr>
