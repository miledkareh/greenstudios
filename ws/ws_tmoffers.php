...
$dealer = $_GET["dealer"];
$bd = $_GET["bd"];
		$sql="Insert into offers (kickoffna,maincontractor,maincontractorreferral,currency,hpdate,bddate,agentdate,update1,projectname,dat,duedate,customerid,userid,country,city,contact,consultantid,architectid,contractorid,";
               ...
               $sql= $sql."landscapearchitect,clientrep,techsupport,design,cancelreason,ls,lsarea,hp,pe,remaining,LastUpdated,LastUser,Manuel,Image,order1,order2,dealer,bd,troom,status,statusdate) values ($kickoffna,$maincontractor,$maincontractorreferral,$currency,'$hpdate','$bddate','$agentdate',1,'$projectname','$date','$duedate',$client,".$_SESSION['UserSerial'].",'$country','$city',";
...
$newphoto=1;
		...
		$sql=" UPDATE offers SET kickoffna=$kickoffna,maincontractor=$maincontractor,maincontractorreferral=$maincontractorreferral,currency=$currency,image1='$image1',image2='$image2',image3='$image3',image4='$image4',image5='$image5',image6='$image6',image7='$image7',image8='$image8',image9='$image9',image10='$image10',image11='$image11',image12='$image12',hpdate='$hpdate',bddate='$bddate',agentdate='$agentdate',update1=1,projectname='$projectname',dat='$date',duedate='$duedate',customerid=$client,country='$country',city='$city',contact='',consultantid=$consultant,architectid=$architect,";
