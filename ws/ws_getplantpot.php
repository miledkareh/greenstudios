...
if(isset($_GET["id"])){
	...
	(select p2.qty-qty from plantpot p1 where size=p2.size and plantid='".$serial."' and type=p2.type   and dat=(select dat from plantpot p3 where size=p2.size and plantid='".$serial."' and type=p2.type   and dat< p2.dat ORDER by dat desc limit 1) limit 1  )as last 
	from plantpot p2 where plantid='".$serial."' order by type asc,dat asc,size";
