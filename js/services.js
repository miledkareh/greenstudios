...
if(ID==0)	
				{
					...
					addAttachment(description,dat,cost);
					
					
				}
		else{ 
		//	window.open("../pages/upload.php?x="+ attachment,"_blank","width=0,height=0");
		UpdateAttachment(ID,description,dat,cost);
...
function UpdateAttachment(serial,description,dat,cost)
	{
		
		  $.ajax({
			  type: 'GET',
			  url: "../../ws/ws_tservices.php",
			  data: ({action:3,serial :serial,description:description,dat:dat,cost:cost}),
...
//=====================================================================================
function addAttachment(description,dat,cost)
	{		
...
//	alert(attachment+" "+paperid+" "+notes);
		  $.ajax({
			  ...
			  type: 'GET',
			  url: "../../ws/ws_tservices.php",
			  data: ({action:1,description:description,dat:dat,cost:cost}),
...
////////////////////////////////////////////////////////////////////////////////////////	
	...
	if(count>0)
	{
		...
		document.getElementById("dat").value=data[0]["dat"];
