...
if(ID==0)	
				{
					...
					addNote(dat,offerid,description);
					
					
				}
		else{ 
		//	window.open("../pages/upload.php?x="+ attachment,"_blank","width=0,height=0");
		UpdateNote(ID,dat,offerid,description);
...
function UpdateNote(serial,dat,offerid,description)
	{
		
		  $.ajax({
			  type: 'GET',
			  url: "../../ws/ws_trefferalnotes.php",
			  data: ({action:3,serial :serial,dat:dat,offerid:offerid,description:description}),
...
//=====================================================================================
function addNote(dat,offerid,description)
	{		
...
//	alert(attachment+" "+paperid+" "+notes);
		  $.ajax({
			  ...
			  type: 'GET',
			  url: "../../ws/ws_trefferalnotes.php",
			  data: ({action:1,dat:dat,offerid:offerid,description:description}),
